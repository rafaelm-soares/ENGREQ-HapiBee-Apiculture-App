...
class FeedingCardList extends Component<Props> {
            ...
            return (
              <div className={styles.card} key={index} onClick={() => (console.log('clicked', item.id))}>
                ...
                <div className={styles.right}>
                  ...
                  <div className={styles.info}>
                    <span className={styles.infoTitle}>Dosagem: </span>
                    <span>{item.dose}</span>
                  </div>
                  <div className={styles.info}>
                    <span className={styles.infoTitle}>Fórmula: </span>
                    <span>{item.formula}</span>
                  </div>
                  <div className={styles.info}>
                    <span className={styles.infoTitle}>Origem: </span>
...
export default connect(mapStateToProps)(FeedingCardList);
